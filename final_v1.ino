...
// ============= WIFI+TMEP ============= //
  ...
  const char* ssid = "Kopretina"; //"Wifi nova"
  const char* password = "SvataKaterina"; //"ajrad1961"

  String serverName = "http://93hapu-ytsm5k.tmep.cz/index.php?"; // Doména lubnovenkovni.tmep.cz a té jsou nastavené přeposílače
